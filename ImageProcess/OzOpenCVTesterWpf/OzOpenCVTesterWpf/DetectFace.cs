...
namespace OzOpenCVTesterWpf
{
    public static class DetectFace
    {
        ...
        static CascadeClassifier eye = null;
          ...
          out long detectionTime)
        {
            ...
            {
                DetectFaceCuda.Detect(image, faceFileName, eyeFileName, faces, eyes, tryUseCuda);
            }
            else
#endif
            {
    ...
    public static class DetectFaceCuda
    {
        static CudaCascadeClassifier face = null;
        static CudaCascadeClassifier eye = null;
        public static void Detect(
          Mat image, String faceFileName, String eyeFileName,
          List<Rectangle> faces, List<Rectangle> eyes,
          bool tryUseCuda)
